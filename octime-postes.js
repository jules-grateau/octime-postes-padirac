(function(){
  ...
  var CSS="*{box-sizing:border-box;font-family:system-ui,Arial,sans-serif}#octp-bouton{position:absolute;right:16px;bottom:16px;pointer-events:auto;background:#2b6cb0;color:#fff;border:none;border-radius:20px;padding:10px 16px;font:600 14px/1 system-ui,Arial,sans-serif;cursor:pointer;box-shadow:0 2px 8px rgba(0,0,0,.3)}#octp-panel{position:absolute;top:0;right:0;bottom:0;left:0;pointer-events:auto;overflow-y:auto;background:#fff;color:#1a202c;font:16px/1.5 system-ui,Arial,sans-serif}#octp-top{position:sticky;top:0;background:#fff;z-index:1}#octp-head{overflow:hidden;padding:14px 16px;background:#2b6cb0;color:#fff;font-size:20px;font-weight:700}#octp-close{float:right;cursor:pointer;font-size:26px;line-height:1;color:#fff;padding:0 0 0 8px}#octp-tabs{font-size:0;background:#f7fafc;border-bottom:1px solid #e2e8f0}.octp-tab{display:inline-block;width:50%;padding:13px 8px;background:none;border:none;border-bottom:3px solid transparent;font:600 17px/1 system-ui,Arial,sans-serif;cursor:pointer;color:#718096;text-align:center;vertical-align:top}.octp-tab.octp-actif{border-bottom-color:#2b6cb0;color:#2b6cb0;background:#fff}#octp-controls,#octp-ctrl-resume{padding:12px 16px;border-bottom:1px solid #e2e8f0}#octp-controls label,#octp-ctrl-resume label{display:block;margin-bottom:8px;font-size:15px}#octp-jour,#octp-filtre,#octp-personne{display:block;width:100%;padding:8px 10px;font-size:15px;border:1px solid #cbd5e0;border-radius:6px;background:#fff;color:#1a202c}#octp-resultat{padding:8px 12px 80px}.octp-grp{margin-bottom:12px}.octp-grp-t{font-weight:700;text-transform:uppercase;font-size:14px;letter-spacing:.04em;border-left:4px solid #2b6cb0;padding:4px 8px;background:#edf2f7;border-radius:3px}.octp-cnt{float:right;background:#2b6cb0;color:#fff;border-radius:10px;padding:0 8px;font-size:11px}.octp-grp ul{margin:6px 0 0;padding:0 0 0 14px;list-style:none}.octp-grp li{padding:1px 0}.octp-code{color:#718096;font-size:11px}.octp-sous-wrap{padding:4px 0 0 8px;border-left:2px solid #e2e8f0;margin:4px 4px 0}.octp-BAT>.octp-sous-wrap{border-left-color:#c6f6d5}.octp-Annexes>.octp-sous-wrap{border-left-color:#d9d6fe}.octp-sous-grp{margin-bottom:7px}.octp-sous-t{font-weight:700;text-transform:uppercase;font-size:12px;letter-spacing:.04em;border-left:3px solid #888;padding:3px 8px;background:#f0f4f8;border-radius:2px}.octp-cnt-sous{float:right;background:#718096;color:#fff;border-radius:10px;padding:0 7px;font-size:10px}.octp-sous-grp ul{margin:4px 0 0;padding:0 0 0 12px;list-style:none}.octp-sous-grp li{padding:1px 0}.octp-BAT>.octp-grp-t{border-left-color:#276749}.octp-sous-B1 .octp-sous-t{border-left-color:#38a169}.octp-sous-B12 .octp-sous-t{border-left-color:#68d391}.octp-sous-B2 .octp-sous-t{border-left-color:#dd6b20}.octp-sous-B22 .octp-sous-t{border-left-color:#f6ad55}.octp-sous-B3 .octp-sous-t{border-left-color:#4b6afa}.octp-sous-BM .octp-sous-t{border-left-color:#9f7aea}.octp-sous-BS .octp-sous-t{border-left-color:#fc8181}.octp-Annexes>.octp-grp-t{border-left-color:#805ad5}.octp-sous-Lift .octp-sous-t{border-left-color:#0694a2}.octp-sous-ADS .octp-sous-t{border-left-color:#5850ec}.octp-sous-Dbarcadre .octp-sous-t{border-left-color:#e3a008}.octp-sous-Embarcadre .octp-sous-t{border-left-color:#e74694}.octp-CE>.octp-grp-t{border-left-color:#e53e3e}.octp-Repos>.octp-grp-t{border-left-color:#a0aec0}.octp-Formation>.octp-grp-t{border-left-color:#d69e2e}.octp-res-stats{display:flex;gap:16px;padding:8px 10px;background:#edf2f7;border-radius:6px;margin-bottom:12px;font-size:13px}.octp-res-grp{margin-bottom:12px}.octp-res-t{font-weight:700;font-size:12px;text-transform:uppercase;letter-spacing:.04em;padding:4px 8px;background:#edf2f7;border-left:4px solid #2b6cb0;border-radius:3px}.octp-res-sous-wrap{padding:4px 0 0 8px;border-left:2px solid #e2e8f0;margin:4px 4px 0}.octp-res-code-grp{margin-bottom:6px}.octp-res-code-t{font-weight:700;text-transform:uppercase;font-size:11px;letter-spacing:.03em;padding:2px 6px;color:#4a5568}.octp-res-code-grp ul{margin:3px 0 0;padding:0 0 0 10px;list-style:none}.octp-res-code-grp li{padding:3px 0;font-size:12px;border-bottom:1px solid #f7f7f7}.octp-res-jour{font-weight:600}.octp-res-jours{padding:2px 6px;color:#4a5568;font-size:12px;line-height:1.9}.octp-res-BAT .octp-res-t{border-left-color:#276749}.octp-res-CE .octp-res-t{border-left-color:#e53e3e}.octp-res-Lift .octp-res-t{border-left-color:#0694a2}.octp-res-ADS .octp-res-t{border-left-color:#5850ec}.octp-res-Dbarcadre .octp-res-t{border-left-color:#e3a008}.octp-res-Embarcadre .octp-res-t{border-left-color:#e74694}.octp-res-Repos .octp-res-t{border-left-color:#a0aec0}.octp-res-Formation .octp-res-t{border-left-color:#d69e2e}";
  ...
  p.innerHTML='<div id="octp-top"><div id="octp-head"><span id="octp-close" title="Fermer">×</span><strong>Effectifs par poste</strong></div><div id="octp-tabs"><button id="octp-tab-postes" class="octp-tab octp-actif">Par poste</button><button id="octp-tab-resume" class="octp-tab">Résumé</button></div><div id="octp-controls"><label>Jour : <select id="octp-jour"></select></label><label><input id="octp-filtre" type="text" placeholder="filtrer un nom…"></label></div><div id="octp-ctrl-resume" style="display:none"><label>Employé : <select id="octp-personne"></select></label></div></div><div id="octp-resultat"></div>';
