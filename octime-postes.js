(function(){
  ...
  p.innerHTML='<div id="octp-head"><div class="octp-titre">Effectifs par poste</div><span id="octp-close" title="Fermer">×</span></div><div id="octp-tabs"><div id="octp-tab-postes" class="octp-tab octp-actif" role="button" tabindex="0">Par poste</div><div id="octp-tab-resume" class="octp-tab" role="button" tabindex="0">Résumé</div></div><div id="octp-controls"><label>Jour : <select id="octp-jour"></select></label><label><input id="octp-filtre" type="text" placeholder="filtrer un nom…"></label></div><div id="octp-ctrl-resume" style="display:none"><label>Employé : <select id="octp-personne"></select></label></div><div id="octp-resultat"></div>';
