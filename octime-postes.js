(function(){
  ...
  var CSS="#octp-bouton{position:fixed;right:16px;bottom:16px;z-index:2147483646;background:#2b6cb0;color:#fff;border:none;border-radius:20px;padding:10px 16px;font:600 13px/1 system-ui,Arial,sans-serif;cursor:pointer;box-shadow:0 2px 8px rgba(0,0,0,.3)}#octp-panel{position:fixed;top:0;right:0;bottom:0;left:0;z-index:2147483647;width:100%;max-height:100%;display:flex;flex-direction:column;background:#fff;color:#1a202c;border:none;border-radius:0;font:13px/1.4 system-ui,Arial,sans-serif;overflow:hidden}#octp-head{display:flex;align-items:center;justify-content:space-between;padding:10px 12px;background:#2b6cb0;color:#fff;flex-shrink:0}#octp-close{cursor:pointer;font-size:20px;padding:0 4px}#octp-tabs{display:flex;background:#f7fafc;border-bottom:1px solid #e2e8f0;flex-shrink:0}.octp-tab{flex:1;padding:9px 4px;background:none;border:none;border-bottom:3px solid transparent;font:600 12px/1 system-ui,Arial,sans-serif;cursor:pointer;color:#718096}.octp-tab.octp-actif{border-bottom-color:#2b6cb0;color:#2b6cb0;background:#fff}#octp-controls,#octp-ctrl-resume{display:flex;flex-direction:column;gap:6px;padding:10px 12px;border-bottom:1px solid #e2e8f0;flex-shrink:0}#octp-controls label,#octp-ctrl-resume label{display:flex;align-items:center;gap:6px}#octp-jour,#octp-filtre,#octp-personne{flex:1;padding:4px 6px}#octp-resultat{overflow:auto;padding:8px 12px 14px}.octp-grp{margin-bottom:12px}.octp-grp-t{font-weight:700;text-transform:uppercase;font-size:12px;letter-spacing:.04em;border-left:4px solid #2b6cb0;padding:4px 8px;background:#edf2f7;border-radius:3px}.octp-cnt{float:right;background:#2b6cb0;color:#fff;border-radius:10px;padding:0 8px;font-size:11px}.octp-grp ul{margin:6px 0 0;padding:0 0 0 14px;list-style:none}.octp-grp li{padding:1px 0}.octp-code{color:#718096;font-size:11px}.octp-sous-wrap{padding:4px 0 0 8px;border-left:2px solid #e2e8f0;margin:4px 4px 0}.octp-BAT>.octp-sous-wrap{border-left-color:#c6f6d5}.octp-Annexes>.octp-sous-wrap{border-left-color:#d9d6fe}.octp-sous-grp{margin-bottom:7px}.octp-sous-t{font-weight:700;text-transform:uppercase;font-size:11px;letter-spacing:.04em;border-left:3px solid #888;padding:3px 8px;background:#f0f4f8;border-radius:2px}.octp-cnt-sous{float:right;background:#718096;color:#fff;border-radius:10px;padding:0 7px;font-size:10px}.octp-sous-grp ul{margin:4px 0 0;padding:0 0 0 12px;list-style:none}.octp-sous-grp li{padding:1px 0}.octp-BAT>.octp-grp-t{border-left-color:#276749}.octp-sous-B1 .octp-sous-t{border-left-color:#38a169}.octp-sous-B12 .octp-sous-t{border-left-color:#68d391}.octp-sous-B2 .octp-sous-t{border-left-color:#dd6b20}.octp-sous-B22 .octp-sous-t{border-left-color:#f6ad55}.octp-sous-B3 .octp-sous-t{border-left-color:#4b6afa}.octp-sous-BM .octp-sous-t{border-left-color:#9f7aea}.octp-sous-BS .octp-sous-t{border-left-color:#fc8181}.octp-Annexes>.octp-grp-t{border-left-color:#805ad5}.octp-sous-Lift .octp-sous-t{border-left-color:#0694a2}.octp-sous-ADS .octp-sous-t{border-left-color:#5850ec}.octp-sous-Dbarcadre .octp-sous-t{border-left-color:#e3a008}.octp-sous-Embarcadre .octp-sous-t{border-left-color:#e74694}.octp-CE>.octp-grp-t{border-left-color:#e53e3e}.octp-Repos>.octp-grp-t{border-left-color:#a0aec0}.octp-Formation>.octp-grp-t{border-left-color:#d69e2e}.octp-res-grp{margin-bottom:10px}.octp-res-t{font-weight:700;font-size:12px;text-transform:uppercase;letter-spacing:.04em;padding:4px 8px;background:#edf2f7;border-left:4px solid #2b6cb0;border-radius:3px}.octp-res-cat{font-weight:400;text-transform:none;letter-spacing:0;color:#718096;font-size:11px}.octp-res-grp ul{margin:4px 0 0;padding:0 0 0 14px;list-style:none}.octp-res-grp li{padding:3px 0;font-size:12px;border-bottom:1px solid #f0f0f0}.octp-res-jour{font-weight:600}.octp-res-jours{padding:3px 8px 0;color:#4a5568;font-size:12px;line-height:1.9}.octp-res-B1 .octp-res-t,.octp-res-B12 .octp-res-t{border-left-color:#38a169}.octp-res-B2 .octp-res-t,.octp-res-B22 .octp-res-t{border-left-color:#dd6b20}.octp-res-B3 .octp-res-t{border-left-color:#4b6afa}.octp-res-BM .octp-res-t{border-left-color:#9f7aea}.octp-res-BS .octp-res-t{border-left-color:#fc8181}.octp-res-CE .octp-res-t{border-left-color:#e53e3e}.octp-res-Lift .octp-res-t{border-left-color:#0694a2}.octp-res-ADS .octp-res-t{border-left-color:#5850ec}.octp-res-Dbarcadre .octp-res-t{border-left-color:#e3a008}.octp-res-Embarcadre .octp-res-t{border-left-color:#e74694}.octp-res-Repos .octp-res-t{border-left-color:#a0aec0}.octp-res-Formation .octp-res-t{border-left-color:#d69e2e}";
  ...
  function rendreResume(){
    ...
    var parCode={};
    for(var d=0;d<P.nb;d++){var code=empData.codes[d]||"";(parCode[code]=parCode[code]||[]).push(d);}
    var codes=Object.keys(parCode).sort(function(a,b){
      var oa=ORDRE_CAT.indexOf(categorie(a)),ob=ORDRE_CAT.indexOf(categorie(b));
      if(oa<0)oa=999;if(ob<0)ob=999;
      return oa!==ob?oa-ob:a.localeCompare(b,"fr");
    });
    var h="";
    codes.forEach(function(code){
      var jours=parCode[code];
      var cat=categorie(code);
      var isADS=(annexeSous(code.toUpperCase())==="ADS");
      var label=code||"Non planifié";
      var catTag=(code&&cat!==code)?' <span class="octp-res-cat">'+cat+'</span>':'';
      var cls=cat.replace(/[^A-Za-z0-9]/g,"");
      h+='<div class="octp-res-grp octp-res-'+cls+'"><div class="octp-res-t">'+label+catTag+' <span class="octp-cnt">'+jours.length+'</span></div>';
      if(isADS){
        h+='<ul>';
